...
aramakutusu = driver.find_element_by_xpath('//input[@type="text"]').send_keys('umitkeskinq') #The search bar that we type target username
sleep(2) #Wait for loading suggestions
profile = driver.find_element_by_xpath('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[3]/div/div[2]/div/div[1]/a').click() 
...
for i in tumLinkler:
    ...
    sleep(2)
    begenbuton = driver.find_element_by_xpath('/html/body/div[5]/div/div/article/div[2]/div[2]/div/section[3]/span[1]/button') 
    begenbuton.click() #Click heart button
    sleep(0.2)
    cikis = driver.find_element_by_xpath('/html/body/div[5]/div/div/article/div[2]/div[1]/div/div[2]/button').click() #Click exit button